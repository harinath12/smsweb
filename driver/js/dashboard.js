...
function drawAreaIntervals() {
    ...
    var data = new google.visualization.DataTable();
        ...
        data.addColumn({id:'i2', type:'number', role:'interval'});
    data.addRows([
        ['2012', 100, 90, 110, 85, 96, 104, 120],
        ['2013', 120, 95, 130, 90, 113, 124, 140],
        ['2014', 130, 105, 140, 100, 117, 133, 139],
        ['2015', 90, 85, 95, 85, 88, 92, 95],
        ['2016', 70, 74, 63, 67, 69, 70, 72]]);

                        ...
                        <table class="table datatable">
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td><?php $created_at=explode(" ",$ques_fet['created_at']); ?>
											...
											<td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="preview-self-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Preview </button></a></li>
                                                    
													<li><a href="overall-report-self-test-answer-view.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Overall Report </button></a></li>

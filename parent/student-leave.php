...
$remark_sql = "SELECT * FROM `student_leave` WHERE student_id = '$user_id'";
                                ...
                                <table class="table datatable">
                                    ...
                                    while($remark_fet=mysql_fetch_array($remark_exe))
                                    {
                                        ...
                                        <tr>
											...
											<?php echo date_display($remark_fet['created_at']); ?>
											</td>
                                            ...
                                            <td>
											<?php //echo $remark_fet['leave_from_date'].' :: '.$remark_fet['leave_to_date']; ?>
											<?php //echo $remark_fet['leave_from_date'].' :: '.$remark_fet['leave_to_date']; ?>
											<?php echo date_display($remark_fet['leave_from_date']); ?>
											<?php if($remark_fet['leave_to_date']!="") { ?>
											<?php echo ' :: '.date_display($remark_fet['leave_to_date']);?>
											<?php } ?>
											</td>
                                            <td>
                                                <?php

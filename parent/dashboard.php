...
<div class="content-wrapper" style="background-color: #3F51B5;">
	...
	<!-- Content area -->
	<div id="parentdashboard" class="content">
        <div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-4">
                <a href="self-test.php">
                    <img src="../admin/image/logo/self-test.png" title="Daily Test" style="height:140px"/>
                </a>
            </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4">
                <a href="#" class="comingsoon">
                    <img src="../admin/image/logo/fees.png" title="Fees" style="height:140px"/>
                </a>
            </div>

            <div class="col-md-2 col-sm-3 col-xs-4">
                <a href="exam-time-table.php">
                    <img src="../admin/image/logo/exam-time-table.png" style="height:140px"/>
                </a>
            </div>

            <div class="col-md-2 col-sm-3 col-xs-4">
                <a href="information_teacher.php">
                    <img src="../admin/image/logo/information-school-teacher.png" style="height:140px"/>
                </a>
            </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4">
                <a href="#" class="comingsoon">
                    <img src="../admin/image/logo/fair-note.png" title="Notice Board" style="height:140px"/>
                </a>
            </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="panel-title text-uppercase pl-10"><a href="home-work-list.php">Home Work</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="panel-title text-uppercase pl-10"><a href="#">Daily Test</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="panel-title text-uppercase pl-10"><a href="#">Projects</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="panel-title text-uppercase pl-10"><a href="gallery.php">Gallery</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-12">
                                <h6 class="panel-title text-uppercase pl-10"><a href="#">Information to school / teacher</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-4 col-sm-3">
                <div class="panel panel-flat bg-indigo">
                    <div class="panel-heading heading-condensed">
                        <div class="row">
                            <div class="col-md-10">
                                <h6 class="panel-title text-uppercase pl-10"><a href="#">Notice Board</a></h6>
                            </div>
                        </div>
                    </div>
                </div>

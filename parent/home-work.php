                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-flat">
							...
							<div class="panel-heading hidden">
                                <h3 class="box-title" style="line-height:30px;">Home Work - <?php echo $className . " " . $sectionName; ?></h3>
                            </div><!-- /.box-header -->
							...
							<div class="col-sm-9">
                                ...
                                <?php if($dat==date("Y-m-d")) { ?>
                                    <h2>TODAY HOME WORK :: <?php //echo $dat; ?><?php echo date_display($dat); ?></h2>
                                <?php } else { ?>
                                    <h2>HOME WORK :: <?php //echo $dat; ?><?php echo date_display($dat); ?></h2>
                                <?php } ?>
                            ...
                            <div class="box-body" id="predate">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col-sm-5'>
                                        <a href="home-work.php?date=<?php echo $prev_date; ?>">
                                    ...
                                    <div class='col-sm-5'>
                                        ...
                                        <?php } else { ?>
                                            <a href="home-work.php?date=<?php echo $next_date; ?>">
                                ...
                                <table id="example3" class="table datatable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
											...
											<?php if($dat==date("Y-m-d")) { ?>
											TODAY HOME WORK :: <?php //echo $dat; ?><?php echo date_display($dat); ?>
											<?php } else { ?>
											HOME WORK :: <?php //echo $dat; ?><?php echo date_display($dat); ?>
											<?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe1 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='I' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe2 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='II' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe3 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='III' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe4 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='IV' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe5 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='V' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe6 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='VI' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe7 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='VII' and date='$dat' and admin_status='1'");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $exe8 = mysql_query("select * from home_work where class='$className' and section='$sectionName' and period='VIII' and date='$dat' and admin_status='1'");

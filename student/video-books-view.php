            ...
            <div class="page-header">
                <div class="page-header-content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="video-books.php">Video Books</a></li>
                        <li class="active">Video Books View</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
...
<?php /* ?>							
							 <table id="example2" class="table datatable curdate">
                                ...
                                $proj_sql="SELECT * FROM `video_books` WHERE `class`='$clsName' AND `subject`='$subjectName' AND `term`='$term' ";
 ...
 <?php 
    $chap_sql = "SELECT * FROM `video_books` WHERE `class`='$clsName' AND `subject`='$subjectName' AND `term`='$term'";
 ...
 <div class="form-group">
		...
		<div class="col-lg-4">
		<form action="" Method="GET" name="chapterForm" id="chapterForm">
			
			<input type="hidden" name="className" value="<?php echo $clsName; ?>" />
			...
			<select class="form-control chapterName" name="chapterName" id="chapterId" >
				...
				<?php while($row = mysql_fetch_assoc($chap_exe)) { ?>
		...
		<div class="col-lg-4">
									...
									$proj_sql="SELECT * FROM `video_books` WHERE `class`='$clsName' AND `subject`='$subjectName' AND `term`='$term' AND `chapter`='$chapterName' ";
									}
									else
									{
									$proj_sql="SELECT * FROM `video_books` WHERE `class`='$clsName' AND `subject`='$subjectName' AND `term`='$term' ";
									...
									$proj_exe=mysql_query($proj_sql);
									$i =1;
									$proj_cnt=@mysql_num_rows($proj_exe);
									if($proj_cnt>0) 
									{										
                                    ?>
                                    <div class="row">
										...
										while($proj_fet=mysql_fetch_array($proj_exe))
										{
                                            ...
                                            <div class="col-md-3 col-lg-3">
                                                <p>
													<?php echo $proj_fet['chapter']; ?> <br/> <?php echo $proj_fet['description']; ?>
                                                </p> 
												
												<video src="../admin/<?php echo $proj_fet['project1']; ?>" class="form-control" style="height: 200px;" controls>
                                            ...
                                            <div class="col-md-3 col-lg-3">
												...
												<video src="../admin/<?php echo $proj_fet['project2']; ?>" class="form-control" style="height: 200px;" controls>
													Your browser does not support the video tag.
												</video>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-lg-3">
												...
												<video src="../admin/<?php echo $proj_fet['project3']; ?>" class="form-control" style="height: 200px;" controls>
													Your browser does not support the video tag.
												</video>
                                            </div>

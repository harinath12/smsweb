                        ...
                        <div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<a href="write-self-test.php?test_id=<?php echo $test_id; ?>" title="View" style="float: right;padding: 10px 100px;"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Write Test</button></a>
								</div>

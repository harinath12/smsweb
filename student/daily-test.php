...
/*
echo $ques_sql = "select q.*, c.class_name from daily_test as q
left join classes as c on c.id = q.class_id
left join class_section as cs on cs.id = q.section_id
where daily_test_status='1' and cs.section_name='$sectionName' and q.class_id='$classId' order by id desc";
*/
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr class="<?php echo $style_class; ?> <?php echo $style_class1; ?>">
											...
											?>
											<a href="review-daily-test-view.php?test_id=<?php echo $test_id; ?>&answer_id=<?php echo $daily_test_answer_id; ?>" title="<?php echo $std_ques_fet['created_at']; ?>">
											...
											<td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="preview-daily-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Read </button></a></li>
                                                    
													<li><a href="write-daily-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Write </button></a></li>
													
													
													<li><a href="overall-report-daily-test-answer-view.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Report </button></a></li>

...
$ques_sql = "select q.*, c.class_name from maths_test as q
                        ...
                        <div class="panel panel-flat">
							<div class="row">
                                ...
                                <div class="col-md-3" style="float: right">
									...
									<?php */ ?>
									<a href="create-maths-test.php"><button type="button" class="form-control btn btn-info">Create Maths Test</button></a>
                                </div>
                            </div>
                            </br>
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr class="<?php echo $style_class; ?> <?php echo $style_class1; ?>">
											...
											?>
											<a href="review-maths-test-view.php?test_id=<?php echo $test_id; ?>&answer_id=<?php echo $daily_test_answer_id; ?>" title="<?php echo $std_ques_fet['created_at']; ?>">
											...
											<td class="text-center">
                                                <ul class="icons-list">
													...
													<li><a href="write-maths-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Write </button></a></li>
													
													<li><a href="overall-report-maths-test-answer-view.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Report </button></a></li>

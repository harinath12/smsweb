            ...
            <div class="page-header">
                <div class="page-header-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Write Self Test</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
                ...
                <div class="row">
                    <div class="panel panel-flat">
                        <div class="panel-body">
							<form action="do-write-self-test.php" method="POST" >
							<div class="row">
                                <div class="col-md-12">
                                ...
                                if($ques_cnt> 0){
                                    ...
                                    while($ques_fet = mysql_fetch_assoc($ques_sql)){
                                        ...
                                        <div class="row" style="margin-left: 20px;">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5">
                                                -&nbsp;&nbsp;&nbsp;
                                                <input class="dictation" type="hidden" name="questions[]" value="<?php echo $ques_fet['id']; ?>" />
                                                <input class="dictation" type="text" name="answers[<?php echo $ques_fet['id']; ?>]" value="" style="width:90%" />
                                            </div>

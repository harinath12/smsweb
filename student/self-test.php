...
where daily_test_status='1' and student_id='$user_id' order by id desc";
                        ...
                        <div class="panel panel-flat">
							<div class="row">
                                ...
                                <div class="col-md-3" style="float: right">
                                    <a href="create-self-test.php"><button type="button" class="form-control btn btn-info">Create Test</button></a>
                                </div>
                            </div>
                            </br>
                            <table class="table datatable">
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
										...
										$check_test_sql = "select COUNT(id) AS self_count from self_test_answer where daily_test_id='$test_id' AND `student_id`='$user_id' AND `created_at` LIKE '$test_date%' order by id asc";
										$check_test_count = mysql_fetch_array(mysql_query($check_test_sql));
										$test_count=$check_test_count['self_count'];
										if($test_count==1) { $style_class1="today"; } else { $style_class1=""; }
										
                                        ?>
                                        <tr class="<?php echo $style_class; ?> <?php echo $style_class1; ?>">
                                            <td><?php echo $i++; ?></td>
                                            <td><?php $created_at=explode(" ",$ques_fet['created_at']); echo $created_at[0]; ?></td>
											...
											?>
											<a href="review-self-test-view.php?test_id=<?php echo $test_id; ?>&answer_id=<?php echo $daily_test_answer_id; ?>" title="<?php echo $std_ques_fet['created_at']; ?>">
											...
											<td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="preview-self-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Read </button></a></li>
                                                    
													<li><a href="write-self-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Write </button></a></li>
													
													<li><a href="overall-report-self-test-answer-view.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Report </button></a></li>
                                                    
													
                                                    <?php /* ?>
													
                                                    <li><a href="review-self-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Review </button></a></li>

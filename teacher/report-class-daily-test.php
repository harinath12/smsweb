            ...
            <div class="page-header">
                <div class="page-header-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Class Daily Test Report </li>
                    </ul>
                    <?php
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr>
											...
											<td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="report-class-daily-test-answer.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View Report</button></a></li>&nbsp;&nbsp;

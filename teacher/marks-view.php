                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" value="<?php echo $mark_fet['subject_name'];?>" class="form-control" readonly />
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        while($student_fet = mysql_fetch_assoc($student_exe)){
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="marks[]" value="<?php if($student_fet['mark'] != 0){ echo $student_fet['mark']; }?>" readonly/> </td>
                                                <td><input type="text" name="remarks[]" value="<?php echo $student_fet['remarks']; ?>" readonly/></td>
                                            </tr>
                                            <?php
                                            $sno++;
                                        }

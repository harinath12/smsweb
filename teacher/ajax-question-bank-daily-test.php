...
where question_bank_status='1' and class_id='$classId' and subject_name='$subName' order by id desc";
        if(!empty($term)){
            $ques_sql = "select q.*, c.class_name from question_bank as q
left join classes as c on c.id = q.class_id
where question_bank_status='1' and class_id='$classId' and subject_name='$subName' and term='$term' order by id desc";
        }
    }
    else if(!empty($term)){
        $ques_sql = "select q.*, c.class_name from question_bank as q
left join classes as c on c.id = q.class_id
where question_bank_status='1' and class_id='$classId' and term='$term' order by id desc";
    }
}
    ...
    $ques_sql = "select q.*, c.class_name from question_bank as q
left join classes as c on c.id = q.class_id
where question_bank_status='1' and class_id='$clsId' and subject_name='$subName' order by id desc";
    if(!empty($term)){
        $ques_sql = "select q.*, c.class_name from question_bank as q
left join classes as c on c.id = q.class_id
where question_bank_status='1' and class_id='$clsId' and subject_name='$subName' and term='$term' order by id desc";
    }
}
    ...
    $ques_sql = "select q.*, c.class_name from question_bank as q
left join classes as c on c.id = q.class_id
where question_bank_status='1' and class_id='$clsId' and term='$term' order by id desc";
}

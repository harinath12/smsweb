                ...
                <div class="page-header-content">
                    ...
                    if(isset($_REQUEST['succ'])) {
                        ...
                        <?php
                            ...
                            <div class="alert alert-success alert-dismessible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Homework Assigned Successfully</strong>
                            </div>
                        <?php
                        }
                    }
                        ...
                        <div class="panel panel-flat">
							<div class="row">
                                ...
                                <div class="col-md-3" style="float: right">
                                    <a href="report-class-daily-test.php"><button type="button" class="form-control btn btn-info">Class Test Report</button></a>
                                </div>
                                <div class="col-md-3" style="float: right">
                                    <a href="report-daily-test.php"><button type="button" class="form-control btn btn-info">Test Report</button></a>
                                </div>
                                <div class="col-md-3" style="float: right">
                                    <a href="create-daily-test.php"><button type="button" class="form-control btn btn-info">Create Test</button></a>
                                </div>
                            </div>
                            </br>
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr>
											...
											$mark_cnt = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS `test_mark` FROM `daily_test_question` WHERE daily_test_id='$daily_test_id'")); 
											echo $mark_cnt['test_mark']; ?>
											</td>
											<td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="preview-daily-test.php?test_id=<?php echo $ques_fet['id']; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Preview</button></a></li>&nbsp;&nbsp;
                                                    <li><a href="doassignhomework.php?test_id=<?php echo $ques_fet['id']; ?>" title="Assign"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Assign Homework</button></a></li>&nbsp;&nbsp;

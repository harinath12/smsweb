...
<div class="page-container" style="min-height:700px">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="fa fa-th-large position-left"></i> ADD CLASS NOTES</h4>
                    </div>
                    <ul class="breadcrumb">
                        <li><a href="dashboard.php"><i class="fa fa-home"></i>Home</a></li>
                        <li><a href="class-notes.php">Class Notes</a></li>
                        <li class="active">Add Class Notes</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
                ...
                <div class="row">
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="doaddclassnotes.php" method="post" enctype="multipart/form-data">
                                <div class="col-md-6">
 ...
 <?php */ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-2">
                                            <!--
                                            <input type="submit" value="ADD" class="btn btn-info form-control" onclick="return confirm('Do you want to add the class notes?');"/>
                                            -->

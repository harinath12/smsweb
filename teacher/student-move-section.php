    ...
    <div class="page-content"><!-- Main sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="fa fa-th-large position-left"></i> STUDENT MOVE SECTION</h4>
                    </div>
                    <ul class="breadcrumb">
                        <li><a href="dashboard.php"><i class="fa fa-home"></i>Home</a></li>
                        <li><a href="student.php"><i class="fa fa-user"></i>Student List</a></li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <form action="do-student-move-section.php" method="POST" name="sectionForm">
                                <?php
                                if($staff_cnt>0)
                                {
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if($classId != 13){
                                                    ...
                                                    <td class="text-center">
                                                       <input type="checkbox" class="students" name="students[]" value="<?php echo $stu_fet['user_id']; ?>" /><?php echo $stu_fet['user_id']; ?>
													<?php /* ?>
                                                        <ul class="icons-list">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-lg-2" style="float:right;">
                                                        <input type="submit" value="MOVE" class="btn btn-info form-control" onClick="return evalGroup()"/>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
				...
				function evalGroup()
				{
					var group = document.getElementsByClassName("students");

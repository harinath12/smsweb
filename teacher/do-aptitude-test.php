...
$query = "INSERT INTO `aptitude_test` (`class_id`, `subject_name`, `section_id`, `daily_test_name`, `daily_test_remark`, `daily_test_chapters`, `daily_test_status`, `created_by`, `updated_by`, `created_at`, `updated_at`) 
           VALUES ('$class_id', '$subject_name', '$section_id', '$daily_test_name', '$daily_test_remark', '$questionbank_id', '1', '$user_name', '$user_name', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000')";
...
$questions_cnt = count($_REQUEST["questions"]);
    ...
    for ($i = 0; $i < $questions_cnt; $i++) {
		...
		$query_question = "INSERT INTO `aptitude_test_question` (`daily_test_id`, `question_id`, `daily_test_question_status`, `created_by`, `updated_by`, `created_at`, `updated_at`) 

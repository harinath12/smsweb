            ...
            <div class="page-header">
                <div class="page-header-content">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="report-self-test-answer.php?test_id=<?php echo $test_id; ?>">Self Test Report Answer</a></li>
                        <li class="active">Self Test Answer View</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
									...
									<div class="form-group">
										...
										<?php 
										$mark_question_query="SELECT COUNT(daily_test_mark) AS mark FROM `self_test_question_answer` WHERE `daily_test_answer_id`='$answer_id'";
										$mark_question_query_exe=mysql_query($mark_question_query);
										$mark_question_query_fet=mysql_fetch_assoc($mark_question_query_exe);
										
										$mark_query="SELECT SUM(daily_test_mark) AS mark FROM `self_test_question_answer` WHERE `daily_test_answer_id`='$answer_id'";
							...
							$ques_query = "SELECT test.`order_id`, qa.* FROM `question_answer` AS qa
											LEFT JOIN self_test_question_answer AS test ON test.`question_id` = qa.id
											LEFT JOIN self_test_answer AS test_ans ON test_ans.`id` = test.daily_test_answer_id

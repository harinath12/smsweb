...
$ques_sql = "select * from aptitude_test_answer where daily_test_id='$test_id' group by student_id order by id desc";
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Aptitude Test Report View</li>
                    </ul>
                </div>
            </div>
            <!-- /page header -->
                                ...
                                if($ques_cnt>0)
                                {
                                    ...
                                    while($ques_fet=mysql_fetch_array($ques_exe))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
											<?php
											$std_ques_sql = "select * from aptitude_test_answer where daily_test_id='$test_id' AND `student_id`='$student_id' order by id asc";
											...
											?>
											<a href="report-aptitude-test-answer-view.php?test_id=<?php echo $test_id; ?>&answer_id=<?php echo $daily_test_answer_id; ?>" title="<?php echo $std_ques_fet['created_at']; ?>">
											...
											<ul class="icons-list">
												<li><a href="overall-report-aptitude-test-answer-view.php?test_id=<?php echo $test_id; ?>&student_id=<?php echo $student_id; ?>" title="View"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View Overall Report</button></a></li>&nbsp;&nbsp;
                                            </ul>    

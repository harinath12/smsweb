...
$home_sql = "select * from class_notes where teacher_id='$user_id' and date='$date' and class='$className' and section='$sectionName' and class_notes_status='1'";
$home_sql = "select * from class_notes where teacher_id='$user_id' and date='$date' and class_notes_status='1'";
                    ...
                    if(isset($_REQUEST['succ'])) {
                        if ($_REQUEST['succ'] == 1) {
                            ...
                            <div class="alert alert-success alert-dismessible">
                                ...
                                <strong>Class Notes inserted Successfully</strong>
                            </div>
                        <?php
                        }
                            ...
                            <div class="alert alert-success alert-dismessible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Class Notes updated Successfully</strong>
                            </div>
                        <?php
                        }
                            ...
                            <div class="alert alert-success alert-dismessible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>Class Notes deleted Successfully</strong>
                            </div>
                        <?php
                        }
                    }
                        ...
                        <div class="panel panel-flat">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="float: right">
                                    <button type="button" class="form-control btn btn-info" id="addClassNotesBtn">Add Class Notes</button>
                                </div>
                            </div>
                            <div class="row" id="editClassNotes">

                            </div>
                            <div class="row" id="addClassNotes" style="display: none;">
                                <div class="panel-body">
                                    <form action="doaddclassnotes.php" method="post" enctype="multipart/form-data" style="border: 1px dotted darkgrey; padding:10px; margin:10px 20px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-lg-4">Class Notes Details</label>
                                                    <div class="col-lg-8">
                                    ...
                                    while($home_fet=mysql_fetch_array($home_exe))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												if($home_fet['class_notes_file_path'])
                                                {
													
												$file_ext = findexts($home_fet['class_notes_file_path']);	
												...
												?>
													...
													<a href="javascript:void(0);" data-href="<?php echo $home_fet['class_notes_file_path']; ?>" class="openPopup">
													<img src="assets/fileicons/<?php echo $file_ext_value; ?>" width="50px" />
													</a>
													&nbsp;&nbsp;&nbsp; 
                                                    <a href="<?php echo $home_fet['class_notes_file_path']; ?>" download> 
                                            ...
                                            <td>
                                                <input type="hidden" class="ClassNotesId" value="<?php echo $home_fet['id'];?>"/>
                                                <button type="button" class="btn btn-info editClassNotesBtn" ><i class="fa fa-pencil"></i></button>
                                                <a href="dodeleteclassnotes.php?id=<?php echo $home_fet['id']; ?>" title="Delete" style="color: black;" onclick="return confirm('Do you want to delete?');">
...
<script>
    $(function() {
        $('#addClassNotesBtn').click(function() {
            $('#addClassNotes').toggle();
            $('#editClassNotes').css("display","none");
        });
    });
</script>
...
<script>
    $(function() {
        $('.editClassNotesBtn').click(function() {
            $('#addClassNotes').hide();
            $('#editClassNotes').toggle();
            var id = $(this).siblings('.ClassNotesId').val();
            $.ajax({
                url: "ajax-edit-class-notes.php?id=" + id,
                context: document.body
            }).done(function(response) {
                $('#editClassNotes').html(response);
            });
        });
    });
</script>
...
<script type="text/javascript">
    function show_confirm() {
        ...
        if(confirm('Do you want to add the Class Notes?'+'\n'+className_Message+'\n'+sectionName_Message+'\n'+subjectName_Message+'\n'+period_Message+'\n'+details_Message))
        {
            return true;
        }
        else

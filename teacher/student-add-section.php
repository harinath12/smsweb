            ...
            <div class="page-header">
                <div class="page-header-content">
                     <div class="page-title">
                        <h4><i class="fa fa-th-large position-left"></i> STUDENT ADD SECTION</h4>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <form action="do-student-add-section.php" method="POST" name="sectionForm">
                                <?php
                                if($staff_cnt>0)
                                {
                                    ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="col-lg-2" style="float:right;">
                                                        <input type="submit" value="ADD" class="btn btn-info form-control" onClick="return evalGroup()"/>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>

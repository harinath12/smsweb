...
$student_sql="SELECT stu.*, aca.roll_number, aca.position, aca.sports, aca.extra_curricular, aca.achievements, c.class_name, aca.section_name FROM `student_general` as stu
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="fa fa-th-large position-left"></i> STUDENT VIEW</h4>
                    </div>
                    <ul class="breadcrumb">

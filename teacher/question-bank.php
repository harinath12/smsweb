                        ...
                        <div class="panel panel-flat">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="float: right">
                                    <a href="questionbankimport.php"><button type="button" class="form-control btn btn-info">Import Question Bank</button></a>
                                </div>
                                <div class="col-md-3" style="float: right">
                                    <a href="questionbankadd.php"><button type="button" class="form-control btn btn-info">Create Question Bank</button></a>
                                </div>
                            </div>
                            </br>

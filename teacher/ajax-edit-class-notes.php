...
$home_exe = mysql_query("Select * from class_notes where id='$hid'");
$home_fet = mysql_fetch_array($home_exe);
?>

<div class="panel-body">
    <form action="doeditclassnotes.php" method="post" enctype="multipart/form-data" style="border: 1px dotted darkgrey; padding:10px; margin:10px 20px;">
        <h4 class="panel-title" style="margin: 0 0 20px 20px;">
            <b>Edit Class Notes</b>
        </h4>
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <div class="col-lg-2">
                        <input type="hidden" name="classnotesId" value="<?php echo $hid; ?>"/>

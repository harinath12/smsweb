...
if($duration == 'More Than One Day'){
    $user_sql = "INSERT INTO `teacher_leave` (teacher_id, title, leave_type, leave_details, leave_filepath, leave_from_date, leave_to_date, leave_status, admin_status, created_by, updated_by, created_at, updated_at) VALUES
...
header("Location: teacher-leave.php?succ=1");

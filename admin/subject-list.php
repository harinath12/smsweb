...
$class_sql="SELECT * FROM `subject_master`";
                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <div class="row">
                                <a href="add-subject.php" style="float: right; margin-right: 10px;"><button type="button" class="btn btn-info btn-md" style="margin-bottom:10px;">Create Subject</button></a>
                            </div>
                            ...
                            if($class_cnt>0)
                            {
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    while($class_fet=mysql_fetch_array($class_exe))
                                    {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $class_fet['subject_name']; ?></td>
                                            <td><?php

                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;">Home Work List</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <?php
                            if($class_cnt>0)
                                    ...
                                    while($class_fet=mysql_fetch_array($class_exe))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <ul class="icons-list">
                                                    <li><a href="home-work-view.php?home_work_id=<?php echo $class_fet['id']; ?>"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></button></a></li>&nbsp;&nbsp;
                                                </ul>
                                            </td>
                                        </tr>
                                        <?php

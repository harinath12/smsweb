...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <!-- Content area -->
            <div class="content">
                <form class="form-horizontal" action="doimportstudent.php" id="addStudentForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="panel-body no-padding-bottom">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control sectionName" name="section" id="sectionId">

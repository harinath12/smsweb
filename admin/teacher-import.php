    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Import Teacher</li>
            </ol>
        </section>
        ...
        <section class="content">
            <!-- Content area -->
            <div class="content">
                <form class="form-horizontal" action="doimportteacher.php" id="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                ...
                                <p>[ <a href="import/teacher-import.xlsx">Download</a> the excel sheet, fill it and then upload. ]</p>
                            </div>

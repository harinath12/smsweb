            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="doupdateclass.php?class_id=<?php echo $class_fet['id']; ?>" method="post">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="className" id="className" value="<?php echo $class_fet['class_name']; ?>" required/>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="status" id="status" required>
                                                ...
                                                <option value="1" <?php if($class_fet['class_status'] == 1){ echo 'selected'; } ?>>Active</option>
                                                <option value="0" <?php if($class_fet['class_status'] == 0){ echo 'selected'; } ?>>Inactive</option>
                                            </select>
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-danger" >
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-12">
                                <a href="class-list.php"><button type="submit" class="btn btn-warning col-md-12" style="margin-bottom:10px;" >Back to Classes List</button></a>
                            </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                </div><!--/.col (right) -->

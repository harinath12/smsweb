...
if(isset($_REQUEST['id'])){
    ...
    if(isset($_REQUEST['send'])) {
        $rem_sql = "update information_teacher set admin_status = '1' where id='$remId'";
        $rem_exe = mysql_query($rem_sql);
        header("Location: information_teacher.php?suc=1");
    }
    else if(isset($_REQUEST['block'])){
        $rem_sql = "update information_teacher set admin_status = '2' where id='$remId'";
        $rem_exe = mysql_query($rem_sql);
        header("Location: information_teacher.php?suc=2");
    }
}
                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;">Parent Request</h3>
                        </div><!-- /.box-header -->
                        <div class="row">
                            <?php
                        ...
                        <div class="box-body" id="predate">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            if($remark_fet['remark_filepath'])
                                            {
                                                ...
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="<?php echo '../parent/' . $remark_fet['remark_filepath']; ?>" download> <i class="fa fa-microphone"></i> </a>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            {
                                                ?>
                                                <a href="information_teacher.php?id=<?php echo $remark_fet['id']; ?>&send=1"> <button class="btn btn-info">SEND</button> </a>
                                                <a href="information_teacher.php?id=<?php echo $remark_fet['id']; ?>&block=1"> <button class="btn btn-info">BLOCK</button> </a>
                                            <?php }
                            ...
                            <?php
                            $rem_sql = "select * from information_teacher where remarks_date='$date' and admin_status='0'";
                            $rem_exe = mysql_query($rem_sql);
...
<script>
    $( function() {
        $( "#datepicker").on( "change", function() {
            var d = $(this).val();
            $.ajax({
                url: "ajax-information-teacher.php?dat=" + d,

...
if(isset($_FILES['project1'])){
    ...
    if(!empty($projbase1)) {
        ...
        $projtarget1 = 'upload/videobook/' . $projname1;
...
if(isset($_FILES['project2'])){
    ...
    if(!empty($projbase2)) {
        ...
        $projtarget2 = 'upload/videobook/' . $projname2;
...
if(isset($_FILES['project3'])){
    ...
    if(!empty($projbase3)) {
        ...
        $projtarget3 = 'upload/videobook/' . $projname3;
...
$date = date("Y-m-d");
 $secName = "";
    $user_sql = "INSERT INTO `video_books` (teacher_id, class, section, subject, term, chapter, date, description, project1, project2, project3, project_status, created_by, modified_by, created_at, updated_at) VALUES
...
header("Location: video-book-list.php?succ=1");

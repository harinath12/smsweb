                    ...
                    <div class="box" style="min-height: 700px;">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="float: right">
                                <button type="button" class="form-control btn btn-info" id="addExamBtn">Add Exam Time Table</button>
                            </div>
                        </div>
                            ...
                            if(isset($_REQUEST['succ'])) {
                                if ($_REQUEST['succ'] == 1) {
                                    ...
                                    <div class="alert alert-success alert-dismessible">
                                        ...
                                        <strong>Exam Time Table inserted Successfully</strong>
                                    </div>
                                <?php
                                }
                                    ...
                                    <div class="alert alert-success alert-dismessible">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <strong>Exam Time Table updated Successfully</strong>
                                    </div>
                                <?php
                                }
                                    ...
                                    <div class="alert alert-success alert-dismessible">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <strong>Exam Time Table deleted Successfully</strong>
                                    </div>
                                <?php
                                }
                            }
                            ...
                            <table id="example2" class="datatable curdate">
                                ...
                                while($exam_fet = mysql_fetch_assoc($exam_exe)){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $exam_fet['start_date']; ?></td>
                                        <td><?php echo $exam_fet['end_date'];; ?></td>
                                        <td>
                                            ...
                                            <?php */ ?>
                                            <a href="editexamtimetable.php?id=<?php echo $exam_fet['id']; ?>" title="Edit" style="color: black;">

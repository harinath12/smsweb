    ...
    <div class="content-wrapper">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Aptitude Report Test Answer View</li>
            </ol>
        </div>
                        ...
                        while($choose_fet = mysql_fetch_assoc($ques_sql)){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $wrong=0;
                                    $none=0;
                                    $ans_query= "SELECT * FROM `aptitude_test_question_answer` WHERE `daily_test_id`='$test_id' AND `question_id`='$qid' AND `daily_test_answer_id` IN ($ans_query_test_ids) ORDER BY `daily_test_answer_id` ASC";
                                    $ans_query_exe=mysql_query($ans_query);
                                    while($ans_query_fet=mysql_fetch_assoc($ans_query_exe))
                                    {
                                        ?>

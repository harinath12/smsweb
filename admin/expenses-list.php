...
$vehicle_sql="SELECT * FROM `expenses` where expense_status='1'";
                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;">Expenses List</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <?php
                            ...
                            <div class="row hidden">
                                <a href="expenses-add.php" style="float: right; margin-right: 10px;"><button type="button" class="btn btn-info btn-md" style="margin-bottom:10px;">Add Expenses</button></a>
                            </div>
                            ...
                            <table id="example2" class="table datatable">
                                ...
                                while($vehicle_fet=mysql_fetch_array($vehicle_exe))
                                {
                                    ...
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $vehicle_fet['expenses_details']; ?></td>
                                        <td><?php echo $vehicle_fet['amount']; ?></td>
                                        <td>
										<?php //echo $vehicle_fet['expense_date']; ?>
										<?php echo date_display($vehicle_fet['expense_date']);?>
										</td>
                                        <td>
                                            <a href="expenses-view.php?id=<?php echo $vehicle_fet['id']; ?>"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View</button></a> &nbsp;&nbsp;
                                            <?php /* ?>
                                            <a href="expenses-edit.php?id=<?php echo $vehicle_fet['id']; ?>"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</button></a> &nbsp;&nbsp;
                                            <a href="expenses-delete.php?id=<?php echo $vehicle_fet['id']; ?>" onclick="return confirm('Do you want to delete the expense?');"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-trash"></i> Delete</button></a>
                                            <?php */ ?>
                                        </td>
                                    </tr>
                                    <?php

...
$proj_sql = "select * from project where date='$date' and project_status='1'";
                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;">Projects</h3>
                        </div><!-- /.box-header -->
                        <div class="row">
                            <div class="col-md-3">
                                <a href="project-add.php">
                                    <button type="button" class="form-control btn btn-info">Add Project</button>
                                </a>
                            </div>
                        ...
                        <div class="box-body" id="predate">
                            ...
                            <?php
                            $project_sql = "select * from project where date='$date' and admin_status='0'";
                            $project_exe = mysql_query($project_sql);
                            $project_cnt = mysql_num_rows($project_exe);
                            if($project_cnt > 0){
                                ?>
                                <div class="row">
                                    <div class='col-sm-2'>
                                        <form action="dosendhomework.php" method="post">
                                            <input type="submit" class="form-control btn btn-info" value="Send" onclick="return confirm('Do you want to send the project?');"/>
                                            <input type="hidden" value="1" name="projectAdminStatus"/>
                                        </form>
                                    </div>
                                </div>
                            <?php

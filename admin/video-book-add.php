    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="book-list.php"> Video Books </a></li>
                <li class="active"> Add Video Book </li>
            </ol>
        </section>
                ...
                <div class="row">
                    <div class="panel panel-flat">
                        <div class="panel-body no-padding-bottom">
                            <div class="col-md-6">
                                <form action="doaddvideobook.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control termName" name="termName" id="termId" required>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control chapterName" name="chapterName" id="chapterId" >
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Video Book Details</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Video Book File(1)</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Video Book File(2)</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Video Book File(3)</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-2">
                                                <input name="sectionName[]" id="sectionId" value="" type="hidden" />
...
<script>
    $(function() {
		...
		$('#classId').change(function() {
            $('#termId').empty();
                var list = "<option value=''>Select Term</option>";
                    list = list + "<option value='Term 1'>Term 1</option>";
					list = list + "<option value='Term 2'>Term 2</option>";
					list = list + "<option value='Term 3'>Term 3</option>";
        ...
        $('#termId').change(function() {
			...
			console.log({cid: $('#classId').val(),sub:$('#subjectId').val(),term:$('#termId').val()});
            $('#chapterId').empty();
            $.get('chapterscriptlist.php', {cid: $('#classId').val(),sub:$('#subjectId').val(),term:$('#termId').val()}, function(result){
				console.log(result);
				var list = "<option value=''>Select Chapter</option>";
                
				
                $.each(JSON.parse(result), function(i,item) {
                    list = list + "<option value='" + item.cid + "'>" + item.cname + "</option>";
                });

                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Vehicles Details</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="docreatevehicle.php" method="post">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" name="bus_no" id="bus_no" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="bus_reg_no" id="bus_reg_no"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="insurance" id="datepicker1" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="fc" id="datepicker2"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Teacher Search</li>
            </ol>
        </section>
                        ...
                        <div class="row" style="padding:10px 10px 0px 0px;">
                            <div class='col-md-2' style="float: right">
                                <div class="form-group">
                                    <a href="teacher-list.php"><input type="button" class="btn btn-info form-control" value="Teacher List"/></a>
                                </div>
                            </div>
                        </div>

                        <form class="form-horizontal" action="teacher-search-list.php" id="addStudentForm" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select name="search[]" class="form-control">
                                                    ...
                                                    <option value="class_handling">Class Handling</option>
                                                    <option value="subject">Subject Handling</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>

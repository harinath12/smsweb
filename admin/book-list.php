...
$proj_sql = "select * from books where project_status='1'";
                ...
                <div class="col-xs-12">
                    <div class="box" style="min-height: 600px;">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;">Books</h3>
                        </div><!-- /.box-header -->
                        <div class="row">
                            <div class="col-md-3">
                                <a href="book-add.php">
                                    <button type="button" class="form-control btn btn-info">Add Book</button>
                                </a>
                            </div>

...
if(isset($_FILES['project1'])){
    ...
    if(!empty($projbase1)) {
        ...
        $movetarget1 = '../teacher/upload/project/' . $projname1;
        $moveprojFile1 = move_uploaded_file($_FILES['project1']['tmp_name'], $movetarget1);
    }
}
...
if(isset($_FILES['project2'])){
    ...
    if(!empty($projbase2)) {
        ...
        $movetarget2 = '../teacher/upload/project/' . $projname2;
        $moveprojFile2 = move_uploaded_file($_FILES['project2']['tmp_name'], $movetarget2);
    }
}
...
if(isset($_FILES['project3'])){
    ...
    if(!empty($projbase3)) {
        ...
        $movetarget3 = '../teacher/upload/project/' . $projname3;
        $moveprojFile3 = move_uploaded_file($_FILES['project3']['tmp_name'], $movetarget3);
    }
}
...
('$user_id','$className', '$secName', '$subjectName', '$date','$description','$projtarget1', '$projtarget2', '$projtarget3', '1','$username', '$username', '$date','$date')";
